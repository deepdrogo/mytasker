...
urlpatterns = [
    ...
    path("assistants/<int:assistant_id>/", views.assistant_detail, name="assistant-detail"),
    path("assistants/<int:assistant_id>/reset-password/", views.assistant_reset_password, name="assistant-reset"),
